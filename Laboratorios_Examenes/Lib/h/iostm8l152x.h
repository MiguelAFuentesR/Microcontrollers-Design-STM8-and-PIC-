/*	IO DEFINITIONS FOR STM8L152XX family
 *	covers: STM8L151x8, STM8L152x8, STM8L15xR6 families
...
volatile char DMA1_C3PARH_C3M1ARH  @0x5096;	/* peripheral address high reg (channel 3) */
volatile char DMA1_C3PARL_C3M1ARL  @0x5097;	/* peripheral address low reg (channel 3) */
...
volatile char I2C1_OARD     @0x5215;	/* Own Address reg for dual mode */
...
volatile char DAC_CH1RDHRH  @0x5388;	/* DAC channel 1 right aligned data holding reg high */
volatile char DAC_CH1RDHRL  @0x5389;	/* DAC channel 1 right aligned data holding reg low */
volatile char DAC_CH1LDHRH  @0x538c;	/* DAC channel 1 left aligned data holding reg high */
volatile char DAC_CH1LDHRL  @0x538d;	/* DAC channel 1 left aligned data holding reg low */
volatile char DAC_CH1DHR8   @0x5390;	/* DAC channel 1 8-bit data holding register */
volatile char DAC_CH2RDHRH  @0x5394;	/* DAC channel 2 right aligned data holding reg high */
volatile char DAC_CH2RDHRL  @0x5395;	/* DAC channel 2 right aligned data holding reg low */
volatile char DAC_CH2LDHRH  @0x5398;	/* DAC channel 2 left aligned data holding reg high */
volatile char DAC_CH2LDHRL  @0x5399;	/* DAC channel 2 left aligned data holding reg low */
volatile char DAC_CH2DHR8   @0x539c;	/* DAC channel 2 8-bit data holding register */
volatile char DAC_DCH1RDHRH @0x53a0;	/* DAC channel 1 right aligned data holding reg high */
volatile char DAC_DCH1RDHRL @0x53a1;	/* DAC channel 1 right aligned data holding reg low */
volatile char DAC_DCH2RDHRH @0x53a2;	/* DAC channel 2 right aligned data holding reg high */
volatile char DAC_DCH2RDHRL @0x53a3;	/* DAC channel 2 right aligned data holding reg low */
volatile char DAC_DCH1LDHRH @0x53a4;	/* DAC channel 1 left aligned data holding reg high */
volatile char DAC_DCH1LDHRL @0x53a5;	/* DAC channel 1 left aligned data holding reg low */
volatile char DAC_DCH2LDHRH @0x53a6;	/* DAC channel 2 left aligned data holding reg high */
volatile char DAC_DCH2LDHRL @0x53a7;	/* DAC channel 2 left aligned data holding reg low */
...
volatile char LCD_FRQ       @0x5403;	/* LCD frequency selection reg */
...
/*	RI section
 */
volatile char RI_ICR1       @0x5431;	/* Timer input capture routing reg 1 */
volatile char RI_ICR2       @0x5432;	/* Timer input capture routing reg 2 */
...
volatile char COMP_CSR1     @0x5440;	/* Comparator control and status reg 1 */
volatile char COMP_CSR2     @0x5441;	/* Comparator control and status reg 2 */
volatile char COMP_CSR3     @0x5442;	/* Comparator control and status reg 3 */
volatile char COMP_CSR4     @0x5443;	/* Comparator control and status reg 4 */
volatile char COMP_CSR5     @0x5444;	/* Comparator control and status reg 5 */
