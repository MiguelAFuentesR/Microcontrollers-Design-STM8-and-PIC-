/*	IO DEFINITIONS FOR STM8S903K3 family
...
volatile char TIM1_DTR      @0x52ce;	/* Dead Time register */
...
volatile char TIM5_IER      @0x5303;	/* Interrupt Enable reg */
volatile char TIM5_SR1      @0x5304;	/* Status register 1 */
volatile char TIM5_SR2      @0x5305;	/* Status register 2 */
volatile char TIM5_EGR      @0x5306;	/* Event Generation reg */
volatile char TIM5_CCMR1    @0x5307;	/* Capture/Compare Mode reg 1 */
volatile char TIM5_CCMR2    @0x5308;	/* Capture/Compare Mode reg 2 */
volatile char TIM5_CCMR3    @0x5209;	/* Capture/Compare Mode reg 3 */
volatile char TIM5_CCER1    @0x530a;	/* Capture/Compare Enable reg 1 */
volatile char TIM5_CCER2    @0x530b;	/* Capture/Compare Enable reg 2 */
...
volatile char TIM5_CCR3H    @0x5315;	/* Capture/Compare reg 3 High */
volatile char TIM5_CCR3L    @0x5316;	/* Capture/Compare reg 3 Low */

/*	TIMER 6 section
 */
volatile char TIM6_CR1      @0x5340;	/* Control register 1 */
volatile char TIM6_CR2      @0x5341;	/* Control register 2 */
volatile char TIM6_SMCR     @0x5342;	/* Slave Mode Control reg */
volatile char TIM6_IER      @0x5343;	/* Interrupt enable reg */
volatile char TIM6_SR1      @0x5344;	/* Status register 1 */
volatile char TIM6_EGR      @0x5345;	/* Event Generation reg */
volatile char TIM6_CNTR     @0x5346;	/* Counter register */
volatile char TIM6_PSCR     @0x5347;	/* Prescaler register */
volatile char TIM6_ARR      @0x5348;	/* Auto-reload register */
