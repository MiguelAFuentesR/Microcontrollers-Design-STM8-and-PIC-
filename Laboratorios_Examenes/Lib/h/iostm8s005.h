/*	IO DEFINITIONS FOR STM8 S005 C6/K6 families
...
/*	CLOCK section
 */
volatile char CLK_ICKR      @0x50c0;	/* Internal Clock Control reg */
volatile char CLK_ECKR      @0x50c1;	/* External Clock Control reg */
...
volatile char UART2_CR5     @0x5248;	/* Control register 5 */
...
volatile char TIM2_CCR3H    @0x5314;	/* Capture/Compare Reg 3 High */
...
volatile char TIM3_PSCR     @0x532a;	/* Prescaler reg High */
