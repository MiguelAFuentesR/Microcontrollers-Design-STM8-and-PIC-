/*	IO DEFINITIONS FOR STM8 S207/S208 S families
...
/*	UART3 section
 */
volatile char UART3_SR      @0x5240;	/* Status register */
volatile char UART3_DR      @0x5241;	/* Data register */
volatile char UART3_BRR1    @0x5242;	/* Baud Rate reg 1 */
volatile char UART3_BRR2    @0x5243;	/* Baud Rate reg 2 */
volatile char UART3_CR1     @0x5244;	/* Control register 1 */
volatile char UART3_CR2     @0x5245;	/* Control register 2 */
volatile char UART3_CR3     @0x5246;	/* Control register 3 */
volatile char UART3_CR4     @0x5247;	/* Control register 4 */
volatile char UART3_CR6     @0x5249;	/* Control register 6 */
